...
ageGateButton: { padding: '15px 30px', backgroundColor: 'var(--color-red-500)', color: 'white', border: 'none', fontSize: '1.2rem', cursor: 'pointer', marginTop: '20px' }
};

if (!isAgeVerified) {
return (
<div style={{ ...styles.global, ...styles.ageGate }}>
<h2 style={{ color: 'white', fontSize: '2rem' }}>ADULT CONTENT WARNING</h2>
...
<button style={styles.ageGateButton} onClick={() => setIsAgeVerified(true)}>ENTER IF 18+</button>
</div>
);
}
